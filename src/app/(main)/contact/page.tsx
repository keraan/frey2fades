"use client"
import {Link, Card, CardBody, Chip} from "@nextui-org/react"
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <div className="flex justify-center max-w-sm">
                            <p className="text-md text-center">
                                To contact me dm my insta, and to see more of my work check my tiktok out.
                            </p>
                        </div>
                        ...
                        <div className="flex justify-center gap-4 pt-4">
                            <Card className="w-full" isHoverable>
                                <a href="https://www.tiktok.com/@patfreyz?lang=en" target="_blank">
                                <CardBody className="p-3">
