    ...
    <div className="w-full">
      <StickyCursor stickyElement={stickyElement} />
        <div className="flex flex-col justify-center items-center m-1 h-full">
          <h1 className="text-4xl md:text-6xl lg:text-8xl font-bold text-black opacity-70">Frey2Fades</h1>
          ...
          <Link href="/booking" className="text-black mb-5">
            <Button radius="full" className="bg-gradient-to-tr from-black-500 to-white-500 shadow-lg" color="primary">
